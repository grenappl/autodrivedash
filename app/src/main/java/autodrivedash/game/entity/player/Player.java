...
public final class Player implements ScreenConstants {
    ...
    public static PlayerCharacter getCurrentCharacter(){ return currentCharacter; }
    public static void setCurrentCharacter(PlayerCharacter newCurrentCharacter){ currentCharacter = newCurrentCharacter; }
